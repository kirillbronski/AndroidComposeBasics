...
/**
 * Store for the app theme. It holds the current app theme and allows
...
interface ThemeDataSource {
    ...
    /**
     * Update the current app theme. This call triggers updating
     * of [themeStateFlow] if you pass the [theme] which differs from the current theme.
     */
